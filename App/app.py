...
st.markdown("""Graphical interface for "Predicting Progression-Free Survival in Hormone-Receptor Positive Metastatic Breast Cancer treated with CDK4/6 Inhibitors: A Machine Learning Approach". """)
st.markdown("""In press: *The Breast*, 2026. https://doi.org/10.1016/j.breast.2026.104715""")
